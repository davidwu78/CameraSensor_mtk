...
class UIStyleSheet:
    ...
    #Frank
    SelectButton = "QPushButton { background-color: rgb(160,160,160); color : black; font: 24px;  border-style: outset; \
        border-width: 2px; border-color: black; border-radius: 15px;} \
        QPushButton::hover { background-color: gray }"
    
    ReturnButton = "QPushButton { background-color: orange; color : black; font: 24px;  border-style: outset; \
        border-width: 2px; border-color: black; border-radius: 15px;} \
        QPushButton::hover { background-color: rgb(204,102,0) }"
    
    HomePageButton = "QPushButton {\
        border: none; border-color: black; border-radius: 60;} \
        QPushButton::hover { background-color: rgb(160,160,160) }"
    
    CalibrateButton = "QPushButton { background-color: rgb(160,160,160); color : black; font: 24px;  border-style: outset; \
        border-width: 2px; border-color: black; border-radius: 15px;padding: 8px;} \
        QPushButton::hover { background-color: gray }"
    
    CameraStettingLocalTitle = "QLabel {background-color: rgb(160,160,160);color : rgb(0,0,0); font: 36px; border-radius: 4px}"
    CameraStettingLocalVariabl = "QLabel {background-color: rgb(160,160,160);color : rgb(0,0,0); font: 24px; border-radius: 4px}"
    CameraStettingGlobalTitle = "QLabel {background-color: rgb(204, 153, 102);color : rgb(0,0,0); font: 36px; border-radius: 4px}"
    CameraStettingGlobalVariabl = "QLabel {background-color: rgb(204, 153, 102);color : rgb(0,0,0); font: 24px; border-radius: 4px}"

    Slider = "QSlider {border-radius: 10px;}\
        QSlider::groove:horizontal {height: 5px;background: rgb(0,0,0);}\
        QSlider::handle:horizontal{background: rgb(255,255,255);width: 20px;height: 20px;margin:-6px 0;border-radius:8px;}\
        QSlider::sub-page:horizontal{background:rgb(255, 128, 0);}"
    
    SliderLabel = "QLabel {background-color: rgb(160,160,160);color : rgb(0,0,0); font: 24px; border-radius: 4px}"

    CameraSettingCameraCombobox = "QComboBox { background-color: rgb(160,160,160); color : rgb(0,0,0); font: 24px; border-radius: 4px;}"
    CameraSettingGlobalVariableCombobox = "QComboBox { background-color: rgb(204, 153, 102); color : rgb(0,0,0); font: 24px; border-radius: 4px;}"

    CameraSystemGroup_1 = "QLabel {background-color: rgb(204, 153, 102);color : rgb(0,0,0); font: 24px; border-radius: 15px}\
        QPushButton { background-color: rgb(204, 153, 102); color : black; font: 24px;  border-style: outset; border-width: 2px; border-color: black; border-radius: 15px;} \
        QPushButton::hover { background-color: rgb(172, 115, 57) }"
    
    CameraSystemGroup_2 = "QLabel {background-color: rgb(160, 160, 160);color : rgb(0,0,0); font: 24px; border-radius: 15px}\
        QPushButton { background-color: rgb(160,160,160); color : black; font: 24px;  border-style: outset; border-width: 2px; border-color: black; border-radius: 15px;} \
        QPushButton::hover { background-color: gray }"
    
    CameraSystemGroup_3 = "QLabel {background-color: rgb(160, 160, 160);color : rgb(0,0,0); font: 24px; border-radius: 15px}\
        QPushButton { background-color: rgb(160,160,160); color : black; font: 24px;  border-style: outset; border-width: 2px; border-color: black; border-radius: 15px;} \
        QPushButton::hover { background-color: gray }"
    
    CameraSystemCameraCombobox = "QComboBox { background-color: rgb(160,160,160); color : rgb(0,0,0); font: 24px; border-radius: 4px;}"

    Check3DLabel = "QLabel {background-color: rgb(160, 160, 160);color : rgb(0,0,0); font: 20px; border-radius: 4px}"

    Check3DXYZ = "QLabel {background-color: rgb(255, 194, 102);color : rgb(0,0,0); font: 24px; border-radius: 4px}"
    # CameraSettingCombobox = "QComboBox { background-color: rgb(160,160,160); border: 1px solid #ced4da; border-radius: 4px;}\
    #     QComboxBox QListView::item{ background-color: rgb(160,160,160)}\
    #     QComboxBox QListView::item:hover{background-color: gray}"
    Model3dCheckBox = 'QCheckBox {color : rgb(0,0,0); font: 25px; border-radius: 4px;} QCheckBox::indicator { width: 27px; height: 27px;};'
    Model3dCheckBoxDisable = 'QCheckBox {color : rgb(192,192,192); font: 25px;} QCheckBox::indicator { width: 27px; height: 27px;};'
    Model3dTable = "QTableWidget {background-color: rgb(249,242,221);}"
    Model3dTableButton = "QPushButton { background-color: rgb(160,160,160); color : black; font: 25px;  border-style: outset; \
        border-width: 3px; border-color: black; border-radius: 15px;} \
        QPushButton::hover { background-color: gray}"
    Model3dTableButtonClicked = "QPushButton { background-color: rgb(255, 165, 0); color : black; font: 25px;  border-style: outset; \
        border-width: 3px; border-color: black; border-radius: 15px;}"
    Model3dTableButtonDisable = "QPushButton { background-color: rgb(96,96,96); color : black; font: 25px;  border-style: outset; \
        border-width: 3px; border-color: black; border-radius: 15px;}"
    Model3dCombobox = "QComboBox { background-color: rgb(160,160,160); color : rgb(0,0,0); font: 25px; border-radius: 4px;}"
    TrajectoryABCheckBox = 'QCheckBox {background-color: rgb(160,160,160); color : rgb(0,0,0); font: 25px;} QCheckBox::indicator { width: 27px; height: 27px;};'
class UIFont:
